...
> **v1.9.5 候选新增：** SEO Strategy、Search Console / GA4 数据洞察、目标驱动 AI 评分、风险感知安全校验和 AI 连接测试。AI 不再只写标题和描述，而是结合网站目标、转化事件、GSC 查询表现、GA4 页面转化数据来给出更贴合业务的 SEO 建议。
...
1.9.4 — 完整更新日志见 [CHANGELOG.md](CHANGELOG.md)
